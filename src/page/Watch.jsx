...
const Watch = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative w-full h-[7vh] md:h-[10vh] overflow-hidden bg-black flex items-center justify-center">
        {/* Background Video */}
      ...
      <div className="bg-black text-white flex flex-col items-center px-4 sm:px-8 md:px-12 lg:px-16 pb-4 ">
        ...
        {/* 1st */}
        <div className="border w-full flex flex-col items-center p-10">
          <h1
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[40px] flex flex-wrap items-center justify-center gap-4 font-bold sm:gap-6 md:gap-8 lg:gap-[30px]
    text-center"
          >
            <span>W A T C H</span>
            <span>A T</span>
      ...
      <div className="bg-black flex items-center justify-center pt-6 px-4 sm:px-8 md:px-12 lg:px-16">
        <div className="border bg-black border-[white] w-full p-10">
          <h1
            className="
        text-2xl sm:text-2xl text-white md:text-5xl lg:text-7xl xl:text-[50px]
      ...
      <div className="bg-black text-white flex flex-col items-center px-4 sm:px-8 md:px-12 lg:px-16 p-10 md:py-16">
        <div className="border w-full flex items-center flex-col p-10">
          <h1
            className="
